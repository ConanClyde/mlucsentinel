...
class StoreMapLocationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'vertices' => ['required', 'array', 'min:3'], // At least 3 points for a polygon
    ...
    public function messages(): array
    {
        return [
            ...
            'vertices.required' => 'Vertices are required.',
            'vertices.min' => 'At least 3 points are required to create a polygon.',
            'vertices.*.x.required' => 'Each vertex must have an X coordinate.',
            'vertices.*.y.required' => 'Each vertex must have a Y coordinate.',
        ];
    }
}
