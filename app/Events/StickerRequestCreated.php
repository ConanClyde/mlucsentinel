...
class StickerRequestCreated implements ShouldBroadcast
{
    ...
    {
        return 'sticker-request-created';
    }
    ...
    public function broadcastWith(): array
    {
        return [
            ...
            'message' => "New sticker request #{$this->stickerRequest->id} submitted by {$this->stickerRequest->user->first_name} {$this->stickerRequest->user->last_name}",
        ];
    }
}
