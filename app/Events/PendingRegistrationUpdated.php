...
class PendingRegistrationUpdated implements ShouldBroadcastNow
{
     ...
     */
    public function __construct(PendingRegistration $pendingRegistration, string $action = 'updated', ?string $editor = null)
    {
    ...
    {
        return 'pending-registration.updated';
    }
    ...
    public function broadcastWith(): array
    {
        ...
        return [
            'pendingRegistration' => [
                ...
                'rejection_reason' => $this->pendingRegistration->rejection_reason,
