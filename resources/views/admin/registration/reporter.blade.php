...
@section('title', 'Reporter Registration')
...
<div class="min-h-screen py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 text-center">
            <h1 class="text-2xl font-bold text-[#1b1b18] dark:text-[#EDEDEC]">Reporter Registration</h1>
            <p class="text-[#706f6c] dark:text-[#A1A09A]">Create a new reporter account</p>
        </div>
        ...
        <div class="bg-white dark:bg-[#1a1a1a] rounded-lg shadow-sm border border-[#e3e3e0] dark:border-[#3E3E3A]">
            <form id="reporterRegistrationForm" method="POST" action="{{ route('admin.registration.reporter.store') }}">
                @csrf
                ...
                <div id="step-2" class="step-content p-6 hidden">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="email" id="email" name="email" class="form-input" placeholder="example@gmail.com, user@dmmmsu.edu.ph, or student@student.dmmmsu.edu.ph" required>
...
<div id="successModal" class="modal-backdrop hidden">
    <div class="modal-container">
        ...
        <div class="modal-body">
            <p>The reporter has been registered successfully and can now access the system.</p>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Form submission
    const form = document.getElementById('reporterRegistrationForm');
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            fetch('{{ route("admin.registration.reporter.store") }}', {
                method: 'POST',
                headers: {
    ...
    function validateEmail() {
        ...
        if (!email) {
            ...
            showFieldError('email', 'Please enter a valid email from Gmail (@gmail.com), DMMMSU (@dmmmsu.edu.ph), or Student DMMMSU (@student.dmmmsu.edu.ph)');
            return false;
        } else {
    ...
    function checkEmailAvailability(email) {
        fetch('{{ route("admin.registration.reporter.check-email") }}', {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                'Content-Type': 'application/json',
...
function isValidEmail(email) {
    const emailRegex = /^[^\s@]+@(gmail\.com|dmmmsu\.edu\.ph|student\.dmmmsu\.edu\.ph)$/;
...
function showStep(step) {
    ...
    if (currentStep === 1) {
        ...
        // Step 2: Show step 2 buttons, hide step 1 buttons
...
function validateCurrentStep() {
    ...
    if (currentStep === 1) {
        ...
        if (!isValidEmail(email)) {
            showErrorModal('Please enter a valid email from Gmail (@gmail.com), DMMMSU (@dmmmsu.edu.ph), or Student DMMMSU (@student.dmmmsu.edu.ph)');
            return false;
        }
