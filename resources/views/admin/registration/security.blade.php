...
<div class="min-h-screen py-4 md:py-8">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 md:mb-8 text-center">
            ...
            <p class="text-sm md:text-base text-[#706f6c] dark:text-[#A1A09A]">Register new Security personnel with vehicle information and account credentials</p>
        </div>
        ...
        <div class="bg-white dark:bg-[#1a1a1a] rounded-lg shadow-sm border border-[#e3e3e0] dark:border-[#3E3E3A]">
            <form id="securityRegistrationForm" enctype="multipart/form-data">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-4">
                        <p class="text-xs md:text-sm text-[#706f6c] dark:text-[#A1A09A]">Add vehicle information for the Staff</p>
                    <button type="button" id="addVehicleBtn" class="btn btn-secondary text-xs md:text-sm">
                ...
                <div id="step-4" class="step-content p-4 md:p-6 hidden">
                    ...
                    <p class="text-xs md:text-sm text-[#706f6c] dark:text-[#A1A09A] mb-4 md:mb-6">Create login credentials for the security personnel to report violators</p>
