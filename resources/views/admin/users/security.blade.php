...
<div class="space-y-6">
    ...
    <!-- Content -->
    <div class="bg-white dark:bg-[#1a1a1a] rounded-lg shadow-sm border border-[#e3e3e0] dark:border-[#3E3E3A] p-6">
        <h3 class="text-lg font-semibold text-[#1b1b18] dark:text-[#EDEDEC] mb-4">This is Security Page</h3>
        <p class="text-[#706f6c] dark:text-[#A1A09A]">
            This page will contain security personnel management functionality including security staff lists, shifts, and assignments.
        </p>
    </div>
</div>
@endsection
